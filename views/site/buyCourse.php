            ...
            <div class="row justify-content-center">
              <div class="col-lg-6 col-md-6 mb-4">
                <div class="course-1-item">
                    ...
                    <div class="row">
                      <div class="col-6">
                          <a href="<?= Url::toRoute(['card', 'id'=>$course->id]);?>"  class="btn btn-primary btn-lg px-5">Картой </a>
                      </div>
                      <div class="col-6">
                          <a href="<?= Url::toRoute(['balance', 'id'=>$course->id, 'user_id'=>Yii::$app->user->id]);?>" class="btn btn-primary btn-lg px-5">С баланса </a>
                    </div>
                  </div>
                    </div>
                </div>
